#
# Author:: Zachary Schneider (<schneider@truesight.com>)
# Type Name:: truesight_meter
# Provider:: truesight_meter
#
# Copyright 2014, Truesight
#
...
Puppet::Type.type(:truesight_meter).provide(:truesight_meter) do

  include Truesight::Meter

  desc "Manage Truesight meters."
